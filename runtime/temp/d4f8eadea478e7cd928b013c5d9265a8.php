<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"D:\www\jia_zhuang\public_html/../apps/admin\view\coupon\index.html";i:1612513465;s:65:"D:\www\jia_zhuang\public_html/../apps/admin/view/public/base.html";i:1563871977;s:46:"../apps/admin/view/public/document_header.html";i:1564739010;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
            ...
            <div class="form-inline" role="form">
                <div class="form-group mt-10">
                    <select name="area_type" class="form-control">
                        ...
                        <?php if(is_array($area_type) || $area_type instanceof \think\Collection || $area_type instanceof \think\Paginator): $i = 0; $__LIST__ = $area_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$are): $mod = ($i % 2 );++$i;?>
                        <option value="<?php echo $key; ?>" <?php if($get['area_type']==$key){echo 'selected';} ?>><?php echo $are; ?></option>
                        ...
                        <div class="bootstrap-table">
                                <div class="fixed-table-toolbar"><div class="bs-bars pull-left">
                                    ...
                                    <!--<div class="form-group">-->
									    <a title="添加" icon="fa fa-plus" class="btn btn-primary btn-sm" href="<?php echo url('edit'); ?>" primary-key="id"><i class="fa fa-plus"></i>  添加</a>&nbsp;
                                ...
                                <div class="fixed-table-container fixed_table_list" style="padding-bottom: 0px;">
                                    ...
                                    <table id="builder-table" class="table table-responsive table-bordered table-hover dataTable" data-pagination="true" data-toolbar="#builder-toolbar" data-query-params="queryParams" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th style="">
                                                <div class="th-inner sortable both">使用场景</div>
                                            </th>

                                            <th style="">
                                                <div class="th-inner sortable both">面额</div>
                                            </th>

                                            <th style="" >
                                                <div class="th-inner sortable both">有效期</div>
                                            </th>
                                            <th style="" >
                                        ...
                                        <tr data-index="<?php echo $key; ?>" data-uniqueid="<?php echo $vo['id']; ?>">
                                            ...
                                            <td style="">
                                                <?php if(is_array($area_type) || $area_type instanceof \think\Collection || $area_type instanceof \think\Paginator): $i = 0; $__LIST__ = $area_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ares): $mod = ($i % 2 );++$i;if($vo['area_type'] == $key): ?> <?php echo $ares; endif; endforeach; endif; else: echo "" ;endif; ?>

                                            </td>

                                            <td style="">￥<?php echo $vo['val']; ?></td>

                                            <td style=""><?php if($vo['get_type'] == 1): ?> <?php echo mydate($vo['end_time'],1); else: ?><?php echo $vo['days']; ?>天<?php endif; ?></td>
