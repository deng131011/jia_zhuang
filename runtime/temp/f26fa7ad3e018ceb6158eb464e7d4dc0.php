                                ...
                                <div class="fixed-table-container fixed_table_list" style="padding-bottom: 0px;">
                                    ...
                                    <table id="builder-table" class="table table-responsive table-bordered table-hover dataTable" data-pagination="true" data-toolbar="#builder-toolbar" data-query-params="queryParams" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <th style="">
                                                <div class="th-inner sortable both">活动标题</div>
                                            </th>
                                            <th style="" >
                                                <div class="th-inner sortable both">开始日期</div>
                                            </th>
                                            <th style="" >
                                                <div class="th-inner sortable both">结束日期</div>
                                            </th>
                                            <th style="" >
                                                <div class="th-inner sortable both">结束状态</div>
                                            </th>
                                            <th style="" >
                                        ...
                                        <tr data-index="<?php echo $key; ?>" data-uniqueid="<?php echo $vo['id']; ?>">
                                            ...
                                            <td style=""><?php echo $vo['start_time']; ?></td>
                                            <td style=""><?php echo $vo['end_time']; ?></td>
                                            <td style=""><?php echo $vo['end_status']; ?></td>
                                            ...
                                            <td style="">
                                                ...
                                                <a class="btn btn-success btn-xs" href="<?php echo url('lists',array('spike_id'=>$vo['id'])); ?>">详情</a>
