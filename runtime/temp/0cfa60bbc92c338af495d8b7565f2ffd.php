<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"G:\phpstudy\www\jia_zhuang\public_html/../apps/admin\view\spike\edit_pro.html";i:1565166950;s:74:"G:\phpstudy\www\jia_zhuang\public_html/../apps/admin/view/public/base.html";i:1563871977;s:46:"../apps/admin/view/public/document_header.html";i:1564739010;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8">
                ...
                <div class="col-md-11">
                  <form action="" method="post" class="form-builder form-horizontal">
                    <fieldset>
                      ...
                      <input type="hidden" name="spike_id" value="<?php echo $info['spike_id']; ?>">

                        <div class="tab_content">
					    <div class="form-group item_title">
							<label class="col-md-2 control-label">商品标题：</label>
							<div class="col-md-4">
							  <input type="text" class="form-control" placeholder="标题" value="<?php echo (isset($info['title']) && ($info['title'] !== '')?$info['title']:''); ?>" readonly >
							</div>
					    </div>
                            ...
                            <div class="form-group item_title">
                                ...
                                <div class="col-md-2">
                                    <input type="number" class="form-control" name="price" placeholder="秒杀价格" value="<?php echo (isset($info['price']) && ($info['price'] !== '')?$info['price']:''); ?>" >
                                </div>
                                <div class="col-md-5 help-block"><i class="fa fa-info-circle color-info1"></i> 必须填写</div>
                            </div>

                            <div class="form-group item_title">
                                <label class="col-md-2 control-label">设置数量：</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control times" name="ms_stock" placeholder="商品数量" value="<?php echo (isset($info['ms_stock']) && ($info['ms_stock'] !== '')?$info['ms_stock']:''); ?>" >
                                </div>
                                <div class="col-md-5 help-block"><i class="fa fa-info-circle color-info1"></i>商品数量</div>
                            </div>

                            <div class="form-group item_title">
                                <label class="col-md-2 control-label">剩余数量：</label>
                                <div class="col-md-2">
                                    <input type="text" class="form-control times" name="mssy_stock" placeholder="剩余数量" value="<?php echo (isset($info['mssy_stock']) && ($info['mssy_stock'] !== '')?$info['mssy_stock']:''); ?>" >
                                </div>
                                <div class="col-md-5 help-block"><i class="fa fa-info-circle color-info1"></i>秒杀商品剩余数量</div>
                            </div>
