...
class User extends Validate
{
    ...
    protected $scene=[
      //  'add' => ['username','username'=>'require|length:1,32|regex:username','email','mobile'=>'regex:mobile|unique:users,mobile,,uid'],
      //  'edit' => ['username','username'=>'require|length:1,32|regex:username','email.email','mobile'=>'regex:mobile'],
    ];
}