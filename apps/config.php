...
$config = [
    ...
    'wechatConfig'  => [
        'AppAppID'       => '',  //APP appid
        'AppAppSecret'   => '',//APP appsecret

        'GzhAppID'       => '',//公众号appid
        'GzhAppSecret'   => '',//公众号appsecret
    ],
    'order_pay_out_time' => '86400',//商品订单24小时未支付，则不能支付
    'hotel_order_payout_time' => '900',//酒店订单15分钟未支付，则不能支付
    'hotel_refund_scale' => 0.2,//退款手续比例
