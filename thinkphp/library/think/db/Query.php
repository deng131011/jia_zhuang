...
class Query
{
     ...
     * @throws DbException
     */
    public function paginate($listRows = null, $simple = false, $config = [],$fileds='')
    {
        if (is_int($simple)) {
            $total  = $simple;
            $simple = false;
        ...
        if (is_null($range)) {
            if (is_array($op)) {
                ...
                switch (strtolower($op)) {
                    ...
                    case 'week':
                    case 'w':
                        $range = ['this week 00:00:00', 'next week 23:59:59'];
                        break;
                    case 'month':
                    case 'm':
                        $range = ['first Day of this month 00:00:00', 'first Day of next month 23:59:59'];
                        break;
                    case 'year':
                    case 'y':
